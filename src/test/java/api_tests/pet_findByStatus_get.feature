...
Scenario Outline: Test GET method with valid status
  ...
  And match response[*].name contains '#string'
  And match response[*].photoUrls contains '#array'
  And match response[*].id contains '#number'
  And match response[*].category contains '#object'
...
Scenario: Test GET method without status
