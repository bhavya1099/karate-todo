...
Examples:
  ...
  | 1      | 'test metadata'   | { read: 'test.jpg', filename: 'test.jpg', contentType: 'image/jpg' } |
  | 2      | 'test metadata'   | { read: 'test.png', filename: 'test.png', contentType: 'image/png' } |
  | 3      | 'test metadata'   | { read: 'test.gif', filename: 'test.gif', contentType: 'image/gif' } |
